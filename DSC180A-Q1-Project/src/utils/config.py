...
def add_method_args(parser):
    """Add method arguments for parser.
   ...
   Args:
    ...
    parser.add_argument('--method',
                       choices=['GOLEM', 'GOLEM_TORCH', 'DAGMA', 'NOTEARS'],
                       help="name of method to be used (GOLEM, GOLEM_TORCH, DAGMA, NOTEARS)")
    parser.add_argument('--loss',
                       choices=["l2", "logistic","poisson"],
                       help="loss function, poisson may only be used with NOTEARS")
...
def add_training_args(parser):
    ...
    parser.add_argument('--early_stop_delta',
                        type=float,
                        default=None,
                        help="Float for early stopping criteria. Set to None to disable. Only used by GOLEM_TORCH")
